...
// - I made this style guide generally based on this: https://github.com/thomasjacobsen-unity/Unity-Code-Style-Guide
//   But reworked it a bit as I see fit.
...
// - You can use and customize this guide for free
// - When in doubt, your team's style guide prevails.


// NAMING/CASING:
// - Use Pascal case for (e.g. NameExample, PlayerStateMachine): public fields, class names, method names, Enums, Namespaces, properties
// - Use camel case (e.g. nameExample, playerStateMachine)for:local variables and private fields, method parameters.
// - Avoid snake case, kebab case, Hungarian notation


// FORMATTING:
// - Choose K&R (opening curly braces on same line) or Allman (opening curly braces on a new line) style braces. (I love Allman style)
// - Keep lines short. Consider horizontal whitespace. Define a standard line width in your style guide (80-120 characters). 
// - Dont use a single space before flow control conditions, e.g. while (x == y)
...
namespace StyleSheetExample
{
    ...
    public interface IDamageable
    {
        ...
        // - Avoid more than four method parameters. This may complicate your method. Maybe you should decompose it
    ...
    public class StyleExample : MonoBehaviour
    {
        ...
        // - Don't omit access modifiers, even private
        ...
        // equivalent to (it's a bit better than the normal property):
        ...
        private void FormatExamples(int someExpression)
        {
            ...
            // But in this case, the parentheses can really be superfluous.
            if (Health <= 0)
                return;
        }
    }
